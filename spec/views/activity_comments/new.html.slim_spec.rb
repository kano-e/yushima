...
RSpec.describe "activity_comments/new", type: :view do
  before(:each) do
    assign(:activity_comment, ActivityComment.new(
      :activity => nil,
      :game => nil,
      :photo => "MyString",
      :detail => "MyString"
  ...
  it "renders new activity_comment form" do
    render

    assert_select "form[action=?][method=?]", activity_comments_path, "post" do
